...
export default function HorizontalEventTimelineCarousel() {
  ...
  return (
    <div className="mx-auto px-4 py-12 max-w-7xl">
      ...
      >
        لأول مرة في تاريخ بلادنا، يتم إنشاء سلطة وطنية مستقلة للإنتخابات أوكل
        لها القانون صلاحيات واسعة، لا سيما فيما يخص تكريس الديمقراطية الدستورية
        و تعميقها و كذا تعزيز النظام الإنتخابي و الإشراف على العمليات الانتخابية
        و مراقبتها و تنظيمها و إجرائها . تستمد السلطة المستقلة للإنتخابات
        مرجعيتها الوحيدة من السيادة الشعبية التي تمارس عبر إنتخابات تتسم بالحرية
        و الشفافية و التعددية و النزاهة
      </motion.p>
